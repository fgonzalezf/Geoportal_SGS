...
<f:subview id="svSecondaryNavigation">
   <f:subview id="svScript">
	...
	<h:form id="frmSecondaryNavigation"
	  ...
	  <h:commandLink action="catalog.publication.statisticals"
	    id="publicationstatisticals"
	    value="#{gptMsg['catalog.publication.statisticals.subMenuCaption']}"
	    styleClass="#{PageContext.menuStyleMap['catalog.publication.statisticals']}"/> 
