...
<head>
<title><%=com.esri.gpt.framework.jsf.PageContext.extract()
						.getSiteTitle()%></title>
...
<body>
	<div id="gptMainWrap" style="position: static;">
		...
		<div id="gptTopBar">
			<div id="gptSkip">
				<ul>
					<li><a href="#gptBody"><h:outputText id="txtSkipToContent"
								value="#{gptMsg['catalog.site.skipToContent']}" /></a></li>
				</ul>
			</div>
		...
		<div id="gptBanner">		   
			...
			<div id="Link2" onclick="window.location='http://www.sgc.gov.co/'"></div>
		</div>
