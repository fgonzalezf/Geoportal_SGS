...
<script type="text/javascript"
	src="<%=schContextPath+"/catalog/js/" +VER121+ "/gpt-search-hint.js"%>"></script>
<% } %>
...
<h:panelGrid columns="4">
	...
	<h:graphicImage id="loadingGif" style="visibility: hidden;"
		url="/catalog/images/loading.gif" alt="" width="30px">
	</h:graphicImage>
	<f:verbatim>
		<div id="hints"></div>
	</f:verbatim>
...
<h:panelGroup id="dockDistributedSearch"
	rendered="#{SearchController.searchConfig.allowExternalSearch == true}">
	<f:verbatim>
		<div id="djtCntDistributedSearches" class="section"
			style="width: 380px">
			<div id="distrSearchTitle">
				<table width="100%">
					<tr>
						<td />
						<td valign="top"><img id="djtCntDistributedSearchesImg"
							alt="" src="/geoportal/catalog/images/section_closed.gif" /></td>
						<td>
							<table width="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td id="djtCntDistributedSearchesTitle" class="sectionCaption" />
								</tr>
								<tr>
									<td id="djtCntDistributedSearchesTitleRemark"
										class="sectionCaptionRemark" />
								</tr>
							</table>
						</td>
					</tr>
			...
			<div id="dvDistributedSearchesContent">
				<div id="cntDistributedSearches" class="sectionBody"></div>
				<div id="cntDistributedSearchesConfigHeader">
					<table width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td id="cntDistributedSearchesConfigCaption"
								class="sectionCaption" />
						</tr>
						<tr>
							<td id="cntDistributedSearchesConfigCaptionRemark"
								class="sectionCaptionRemark" />
						</tr>
					</table>
				</div>
        ...
        --%>
				<div id="cntDistributedSearchesConfig" class="sectionBody"
...
<h:outputLink id="scLnkAdditionals"
	onclick="javascript:scShowDialog('crtAdvOptnsContent', true)"
	value="javascript:void(0)">
	<h:outputText escape="false"
		value="#{gptMsg['catalog.search.additionalOptions']}" />
</h:outputLink>
...
<h:outputText id="scLblSptial"
	value="#{gptMsg['catalog.search.filterSpatial.title']}" />
<h:outputText escape="false" value="</h3>" />
<h:panelGrid columns="1" id="scPnlSpatial">
	...
	<h:panelGrid id="pnlMap">
		<h:panelGroup id="mapToolbar" styleClass="mapToolbar">
			<h:outputLabel for="mapInput-locate"
				value="#{gptMsg['catalog.search.search.lblLocator']}" />
			<h:inputText id="mapInput-locate" styleClass="locatorInput"
				maxlength="1024" onkeypress="return scMap.onLocatorKeyPress(event);" />
			<h:graphicImage id="mapButton-locate"
				url="/catalog/images/btn-locate-off.gif"
		...
		<f:verbatim>
			...
			<div id="interactiveMap" dojotype="dijit.layout.ContentPane"
				style="width: 380px; height: 240px; cursor: pointer; border: 1px solid #000000;">
			</div>
		</f:verbatim>
...
<h:outputText escape="false"
		value='<div style="padding:0px 10px 10px 10px;">' />
	<% // content type %>
	<h:panelGroup id="_pngCtypeLocal">
		<h:outputText escape="false" value="<h3>" />
		<h:outputLabel for="scSelContent" id="scLblContent"
			value="#{gptMsg['catalog.search.filterContentTypes.title']}" />
		<h:outputText escape="false" value="</h3>" />
	...
	<h:panelGroup id="_pngCtypeRemote">
		<h:outputText escape="false" value="<h3>" />
		<h:outputLabel for="scSelContentR" id="scLblContentR"
			value="#{gptMsg['catalog.search.filterContentTypes.title']}" />
		<h:outputText escape="false" value="</h3>" />
	...
	<h:panelGroup id="_pngDataThemes">
		<h:outputText escape="false" value="<h3>" />
		<h:outputText id="scLblTheme"
			value="#{gptMsg['catalog.search.filterThemeTypes.title']}" />
		<h:outputText escape="false" value="</h3>" />
		<h:outputText escape="false"
			value='<div style="overflow:auto; height:200px;">' />
		<h:panelGrid id="scPnlTheme">
			<h:selectManyCheckbox id="scSelTheme" layout="pageDirection"
				...
				<f:selectItem itemLabel="#{gptMsg['catalog.mdCode.topic.farming']}"
					itemValue="farming" />
				<f:selectItem
					itemLabel="#{gptMsg['catalog.mdCode.topic.climatologyMeteorologyAtmosphere']}"
					itemValue="climatologyMeteorologyAtmosphere" />
				<f:selectItem itemLabel="#{gptMsg['catalog.mdCode.topic.biota']}"
					itemValue="biota" />
				<f:selectItem itemLabel="#{gptMsg['catalog.mdCode.topic.economy']}"
					itemValue="economy" />
				<f:selectItem
					itemLabel="#{gptMsg['catalog.mdCode.topic.planningCadastre']}"
					itemValue="planningCadastre" />
				<f:selectItem itemLabel="#{gptMsg['catalog.mdCode.topic.society']}"
					itemValue="society" />
				<f:selectItem
				...
				<f:selectItem itemLabel="#{gptMsg['catalog.mdCode.topic.health']}"
					itemValue="health" />
				<f:selectItem
				...
				<f:selectItem itemLabel="#{gptMsg['catalog.mdCode.topic.location']}"
					itemValue="location" />
				<f:selectItem
					itemLabel="#{gptMsg['catalog.mdCode.topic.intelligenceMilitary']}"
					itemValue="intelligenceMilitary" />
				<f:selectItem itemLabel="#{gptMsg['catalog.mdCode.topic.oceans']}"
					itemValue="oceans" />
				<f:selectItem
	...
	<h:panelGroup id="_pngModDateSection">
		<h:outputText escape="false" value="<h3>" />
		<h:outputText id="scLblDate"
			value="#{gptMsg['catalog.search.filterTemporal.title']}" />
		<h:outputText escape="false" value="</h3>" />
	...
	<h:panelGroup id="_pngSortSection">
		<h:outputText escape="false" value="<h3>" />
		<h:outputLabel for="scSelSort" id="scLblSort"
			value="#{gptMsg['catalog.search.filterSort.labelSort']}" />
		<h:outputText escape="false" value="</h3>" />
